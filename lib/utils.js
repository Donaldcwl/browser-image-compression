...
const fileType = (moduleMapper && moduleMapper.getOriginalSymbol(window, 'File')) || File;
const fileReader = (moduleMapper && moduleMapper.getOriginalSymbol(window, 'FileReader')) || FileReader;
