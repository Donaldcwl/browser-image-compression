...
imageCompression.enableCordovaSupport = () => {
  ...
  window.File = (moduleMapper && moduleMapper.getOriginalSymbol(window, 'File')) || File;
  window.FileReader = (moduleMapper && moduleMapper.getOriginalSymbol(window, 'FileReader')) || FileReader;
}
